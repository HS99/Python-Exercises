'''Program X - Consider the marks of 4 assignment, 2 tests and 2 labs,
store these in dictionary. Calculate the average marks and grade of a student
and the entire class as well. Implement using functions'''
